<div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="wrapper wrapper-content animated fadeIn">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <?= form_open_multipart('Admin/photoAndroid', ['class' => 'form-horizontal']) ?>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?= base_url()?>uploads/photoAndroid/<?=  $row->nama_foto ?>" width="100px" height="100px"></td>
                ...
                function hapus(id){
                    ...
                    .then((willDelete) => {
                    if (willDelete) {
                        $.post('<?php echo base_url(); ?>Admin/photoAndroid', {delete: true, id: id})
