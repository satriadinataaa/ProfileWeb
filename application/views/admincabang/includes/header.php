...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/assetsadmin/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
    ...
    <script src="<?=base_url()?>assets/assetsadmin/js/jquery.mask.min.js"></script>
    <script src="<?=base_url()?>assets/assetsadmin/js/nicEdit.js"></script>
